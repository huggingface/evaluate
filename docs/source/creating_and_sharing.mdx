...
The computation is performed in the [`EvaluationModle._compute`] method. It takes the same arguments as `EvaluationModuleInfo.features` and should then return the result as a dictionary. Here an example of a exact match metric:
