...
|:-------------------------------------------------------------------|-------------:|-------------------:|------------------------:|---------------------:|---------------------:|
| ArBert/albert-base-v2-finetuned-ner                                |        0.000 |              0.000 |                   4.395 |              227.549 |                0.004 |
| Jean-Baptiste/roberta-large-ner-english                            |        0.000 |              0.833 |                  11.494 |               87.003 |                0.011 |
| dbmdz/bert-large-cased-finetuned-conll03-english                   |        0.962 |              0.881 |                  11.592 |               86.263 |                0.012 |
| dbmdz/electra-large-discriminator-finetuned-conll03-english        |        0.965 |              0.881 |                  11.425 |               87.529 |                0.011 |
| elastic/distilbert-base-uncased-finetuned-conll03-english          |        0.940 |              0.989 |                   2.344 |              426.634 |                0.002 |
| gunghio/distilbert-base-multilingual-cased-finetuned-conll2003-ner |        0.947 |              0.991 |                   2.423 |              412.781 |                0.002 |
| philschmid/distilroberta-base-ner-conll2003                        |        0.961 |              0.994 |                   2.536 |              394.374 |                0.003 |
| xlm-roberta-large-finetuned-conll03-english                        |        0.969 |              0.882 |                  12.082 |               82.765 |                0.012 |
...
However, beware that some models on the Hub have a label mapping that do not match with the dataset mapping! This may be that there is even no `label2id`, or that the labels are uninformative (`LABEL_0`, `LABEL_1`, etc.). In such case, it is best to inspect the dataset features in `data.features`, and to use if possible (Dataset.align_labels_with_mapping)[https://huggingface.co/docs/datasets/en/package_reference/main_classes#datasets.Dataset.align_labels_with_mapping] to align the dataset labels with the model's outputs.
