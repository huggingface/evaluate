...
Before you start, you will need to setup your environment and install the appropriate packages. 🤗 Evaluate is tested on **Python 3.6+**.

<Tip>

If you want to use 🤗 Evaluate with TensorFlow or PyTorch, you will need to install them separately. Refer to the [TensorFlow](https://www.tensorflow.org/install/pip#tensorflow-2-packages-are-available) or the [PyTorch installation page](https://pytorch.org/get-started/locally/#start-locally) for the specific install command for your framework.
...
🤗 Evaluate can also be installed with conda, a package management system:
